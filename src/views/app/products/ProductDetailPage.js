...
import CompleteOrdersDoughnut, { PendingOrdersDoughnut } from '../../../containers/dashboards/CompleteOrdersDoughnut';
                ...
                <TabPane tabId="details">
                  <Row>
                        ...
                        <CardBody>
                          ...
                          <Row>
                            <Colxx className="mt-2" xxs={12}>
                              <span>
                                Advertise End Date:{' '}
                                {moment(product.advertiseEnd).format('ddd, MMM Do YYYY')}
                              </span>
                            </Colxx>
                            <Colxx className="mt-2" xxs={12}>
                              <span>
                                Advertise End Time:{' '}
                                {moment(product.advertiseEnd).format('h:mm:ss a')}
                              </span>
                            </Colxx>
                          </Row>
                        </CardBody>
                    ...
                    <Colxx xxs="12" lg="8">
                      <Row>
                        <Colxx xxs="6" lg="6">
                          <CompleteOrdersDoughnut />
                        </Colxx>
                        <Colxx xxs="6" lg="6">
                          <PendingOrdersDoughnut />
                        </Colxx>
