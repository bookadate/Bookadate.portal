...
function Table2({ columns, data, divided = false, defaultPageSize = 6 }) {
  const {
    getTableProps,
    getTableBodyProps,
    prepareRow,
  ...
  return (
    <>
      ...
      {/* <PendingBookings orders={()=>page.map(i=>i.values)} /> */}
...
const DataListDividedTable = () => {
  ...
  return (
    <div className="mb-4 mt-2">
      ...
      {/* </CardTitle> */}
      <Table2 columns={cols} data={products} divided />
